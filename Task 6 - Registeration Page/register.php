...
<body>
    ...
    <div class="authentication-wrapper authentication-basic container-p-y">
      <div class="authentication-inner">
        ...
        <div class="card">
          <div class="card-body">
            <?php if ($alertMsg !== '') {
              echo '<div class="alert alert-primary alert-dismissible" id="errMsg" role="alert">' . $alertMsg . '</div>';
            } ?>
            <!-- Logo -->
            <div class="app-brand justify-content-center">
              <a href="index.html" class="app-brand-link gap-2">
                ...
                <span class="app-brand-text demo text-body fw-bolder">Task</span>
              </a>
            </div>
            <!-- /Logo -->

            <form id="Authentication" class="mb-3" method="POST" enctype="multipart/form-data">
              <div class="mb-3">
              ...
              <div class="mb-3">
                <label for="مname" class="form-label">Last Name</label>
  ...
  <script src="Backend/passwordValid.js"></script>
